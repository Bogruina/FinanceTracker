namespace FinanceTracker.IdentityServer.Extensions;
...
public static class ConfigurationExtensions
{
    ...
    public static bool IsSectionExists(
    ...
    public static bool IsSectionNotExists(
        this IConfiguration configuration,
        string path
    )
    {
    ...
    /// <c>false</c> otherwise.
    /// </returns>
    public static bool IsParameterExists(
        this IConfiguration configuration,
        string path
    )
    {
        return !string.IsNullOrEmpty(GetParam(configuration, path));
    }
    ...
    /// <c>false</c> otherwise.
    /// </returns>
    public static bool IsParameterNotExists(
        this IConfiguration configuration,
        string path
    )
    {
    ...
    /// <c>false</c> otherwise.
    /// </returns>
    public static bool TryGetParam(
        this IConfiguration configuration,
        string path,
        out string value
    )
    {
        value = GetParam(configuration, path);
