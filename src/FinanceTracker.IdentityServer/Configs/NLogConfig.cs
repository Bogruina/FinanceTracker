...
namespace FinanceTracker.IdentityServer.Configs;
...
public static class NLogConfig
{
    ...
    public static void UseNLogAsLoggerProvider(
    ...
    private static void SetLogManagerConfiguration(
        IConfiguration configuration
    )
    {
        var nlogConfigurationFileName = GetNLogConfigFileName(
            configuration
        );
